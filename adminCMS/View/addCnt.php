...
<form action="../Api/addCntApi.php" method="post">      
	<table width="470" border="0" cellspacing="0" cellpadding="0">
		...
		<tr>
		  ...
		  <td class="align_l"><input type="text" name="title" id="title" /></td>
		  </tr>
		<tr>
		  <td class="align_r">文章作者:</td>
		  <td class="align_l"><input type="text" name="auther" id="auther" value="管理员"/></td>
		</tr>
		<tr>
		  <td class="align_r">标题图片:</td>
		  <td class="align_l">
		  	<input type="button" onClick="upImage()" value="上传图片"> 
		  	<input type="text" id="srcTxt" name="titleImg" />
			<div id="img_box">				
			</div>	
		  </td>
		</tr>
